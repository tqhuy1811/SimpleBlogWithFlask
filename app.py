from flask import Flask,render_template,logging,flash,redirect,url_for,session,request
...
class RegisterForm(Form):
    ...
    password = PasswordField('Password',[validators.DataRequired(),validators.EqualTo('confirm',message="Password not match")])
...
def dashboard():
    ...
    if result > 0:
        ...
        msg = 'No Articles Found'
        return render_template('dash_board.html',msg=msg)
    cur.close()
...
if __name__ == '__main__':
  app.secret_key="asdsadsadsadasdasd"
  app.run()